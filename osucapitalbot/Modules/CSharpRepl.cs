...
public class CSharpReplModule : InteractionModuleBase<SocketInteractionContext>
{
  ...
  private readonly string[] _imports = new string[]
  {
    ...
    "Discord.WebSocket",
    "osucapitalbot",
    "osucapitalbot.Models",
    "osucapitalbot.Models.Capital",
    "osucapitalbot.Modules",
    "osucapitalbot.Modules.Capital",
    "osucapitalbot.Persistence",
    "osucapitalbot.Services",
    "osucapitalbot.Utilities",
  };
  ...
  public CSharpReplModule(IServiceProvider provider, IConfiguration config, OsuApiService osu, OsuCapitalApiService capital)
  {
    _provider = provider;
    _config = config;
    _osu = osu;
    ...
    [Summary("code", "The C# code to execute.")] string code)
  {
    ...
    foreach (string secret in new string[] { "BOT_TOKEN", "OSU_API_KEY" })
  ...
  public class ScriptGlobals
  {
    ...
    /// <summary>
    /// The osu!capital api service.
    /// </summary>
    public required OsuCapitalApiService CapitalApi { get; init; }
  }
}
